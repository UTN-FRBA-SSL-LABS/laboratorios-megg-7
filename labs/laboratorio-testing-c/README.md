...
> R:4700 (escribí el total esperado)
...
> R:es importante llamarla porque inicializa el carrito vacio para poder ir agrengando productos
...
> R:si devuelve el total unitario de 350
...
> R:falla, el valor esperado es 700 y el obtenido 350
...
> R:linea 24, el codigo recorre todos los productos del carrito pero solo suma el precio unitario ya que sabe la cantidad pero nunca multiplica el precio por esa cantidad

**P7** — ¿Qué debería hacer esa línea para calcular el total correctamente?

> R:deberia multiplicar el precio unitario por la cantidad de productor
...
> R:falla y dice que esperaba 0 y obtuvo 1 
...
> R: el operador incorrecto en el menor igual, deberia ser unicamente menor 
...
> R:si la linea 29 y 30, que es carrito_descuento ya que ningun test la utilizo 
...
> R:El unitario se enfoca en el producto especifico de forma aislada y el de integracion trabaja con el conjunto. El primero en detectar el error fue el unitario
...
> R: porque c no tiene restricciones y termina por dejarte escribir fuera del rango establecido mientras que en python o java no se puede
...
> R:que me permite ver bugs que de otra forma hubiera pasado desapercibido 
...
> R: porque era una unidad en cambio cuando la cantidad cambio era evidente
